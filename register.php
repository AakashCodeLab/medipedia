...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
 <tr> 
  <td><img src="medicine/medi.png" width="900" height="100"></td>
 </tr>
 <tr> 
  <td valign="top">
        ...
        <tr> 
		 ...
		 <div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           <tr align="center"> 
            <td colspan="2"><div align="right"><a href="l.php">Back</a></div></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;User Name</td>
             <td class="content"><input name="txtUserName" type="text" required="required" class="box" id="txtUserName" size="30" maxlength="20"></td>
           </tr>
           <tr class="entryTable">
